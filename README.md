...
仓库需要保留并上传 `.github/workflows/build.yml`。它负责在 GitHub 上自动打包 Windows 与 macOS arm64 版本。

手动触发：进入 GitHub 仓库的 Actions 页面，选择 Build Artifex Display Converter，点击 Run workflow。
